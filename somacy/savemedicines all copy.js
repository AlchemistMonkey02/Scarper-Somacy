...
(async () => {
    ...
    const collectionUrl = 'https://www.netmeds.com/collection/adhd-medicines';
    ...
    // Save to JSON
    await fs.writeFile('adhd_medicines_data.json', JSON.stringify(medicinesData, null, 2));
    console.log(`✅ Successfully saved ${medicinesData.length} medicines to adhd_medicines_data.json`);
